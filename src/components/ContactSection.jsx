...
const ContactSection = () => {
  return (
    <section id='contact' className=" bg-background-sm text-white py-24 px-6 relative overflow-hidden rounded">
        ...
        <p className="text-base md:text-lg text-white/70 mb-8">
         ...
         <a
          href="mailto:varunakamthi522004@gmail.com"
           className="inline-flex items-center justify-center px-8 py-3 border border-purple-500 text-white rounded-lg hover:bg-purple-600 transition duration-300">
