...
const ContactSection = () => {
  return (
    <section
  id="contact"
  className="bg-background-sm py-20  px-6 relative overflow-hidden rounded"
>
  <div className="container mx-auto max-w-4xl text-center pb-30">
  ...
  {/* Footer */}
  <div className="absolute bottom-6 left-6 text-sm pb-10">
    © 2025 <span className="font-semibold">Varun Kamathi</span>
  </div>

  {/* Social Icons */}
  <div className="absolute bottom-6 right-6 flex gap-4 pb-10">
    <a
