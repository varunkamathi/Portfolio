...
const HeroSection = () => {
  return (
    <section id='hero' className='realtive min-h-screen flex flex-col items-center justify-center px-4 '>
        <div className='container max-w-4xl mx-auto text-center z-10 mb-16'>
            ...
            <p className='text-lg md:text-xl text-muted-foreground max-2-2xl mx-auto opacity-0 animate-fade-in-delay-3'>As a Full Stack Developer, I don't just build features. I build scalable,
                 reliable, and user-focused products with confidence and precision</p>
            </div>
        ...
        <div className='absolute bottom-4 left-0.6 transform translate-x-0.5 flex flex-col itme-center animate-bounce'>
